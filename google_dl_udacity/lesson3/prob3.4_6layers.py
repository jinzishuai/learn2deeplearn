...
with graph.as_default():
  ...
  dropout1 = tf.nn.dropout(activated_hidden_layer1, keep_rate) #dropout if applied after activation

  hidden_layer2 = tf.matmul(dropout1, weights2) + biases2
  activated_hidden_layer2 = tf.nn.relu(hidden_layer2)
  dropout2 = tf.nn.dropout(activated_hidden_layer2, keep_rate) #dropout if applied after activation

  hidden_layer3 = tf.matmul(dropout2, weights3) + biases3
  activated_hidden_layer3 = tf.nn.relu(hidden_layer3)
  dropout3 = tf.nn.dropout(activated_hidden_layer3, keep_rate) #dropout if applied after activation
  
  hidden_layer4 = tf.matmul(dropout3, weights4) + biases4
  activated_hidden_layer4 = tf.nn.relu(hidden_layer4)
  dropout4 = tf.nn.dropout(activated_hidden_layer4, keep_rate) #dropout if applied after activation

  logits = tf.matmul(dropout4, weights5) + biases5 
  ...
  test_prediction = tf.nn.softmax(  tf.matmul(layer4, weights5 ) + biases5 )
